...
import { User, Mail, Phone, MapPin, Calendar, Heart, Briefcase, GraduationCap, Camera, Upload, ChevronLeft, ChevronRight, Save, Check, AlertCircle, FileText, CreditCard, Video, Building, DollarSign, Users, Globe, Clock, Target, Star, Coffee, Music, Book, Plane, Dumbbell, Palette, TowerControl as GameController2, Utensils, Film, Mountain, Camera as CameraIcon, Headphones, Bike, TreePine, Waves, Sun, Moon, Zap, Flower, Sparkles } from 'lucide-react';
