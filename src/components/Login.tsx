          ...
          <div className="w-full max-w-2xl">
            ...
            {!showEmailForm ? (
              ...
              <div className="mb-16">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Enter your email address and we'll send your a link to login instantly without a password!
                </p>
              </div>
            )}
            ...
            {!showEmailForm ? (
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 text-gray-500 hover:text-gray-700 transition-colors font-medium mb-4"
                >
